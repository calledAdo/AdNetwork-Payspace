...
//
// Files live under DATA_DIR (default ./packages/payspace_backend/data).
...
const DATA_DIR = process.env.DATA_DIR ?? path.join(process.cwd(), "packages/payspace_backend/data");
