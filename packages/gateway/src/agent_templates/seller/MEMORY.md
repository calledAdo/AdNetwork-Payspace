...
Slot inventory arrives through owner commands such as `register_slot`.
...
- newly registered slots should start in `awaiting_install`
- after backend `snippet-seen`, slots should move to `publishing`
